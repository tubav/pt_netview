...
/**
 * 
 * Controls main tabbed pane.
 *
 * @author FhG-FOKUS NETwork Research
 */
public final class MainTabbedPaneController extends TabbedPaneController implements Controllable {
	public MainTabbedPaneController(TabbedPaneModel model) {
		super(model);
