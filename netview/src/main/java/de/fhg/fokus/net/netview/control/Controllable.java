...
public interface Controllable {
	/**
	 * Initialization method. After calling this method, the controllable must be ready
	 * to be used and should respond to events.
	 * 
	 */
	void init();
	/**
	...
	void start();
	/**
	 * Stop controller. After calling this method  controllable should ignore events. 
	 */
	void stop();
