...
/**
 * Every entity class (model) should implement this interface.
 * @author FhG-FOKUS NETwork Research
 */
public interface PersistentPreferences {
	/**
	 * Load preferences, i.e. load state information from previous runs.
	 */
	public void loadPreferences();
	/**
	 * Save preferences, i.e. save state information so when application starts again it 
	 * has the same state the user left of.
	 */
