...
public class TrackPerPacketDelayChart extends JFrame {
    ...
    public TrackPerPacketDelayChart(NetViewDB netViewDB, String title, long trackId, long time) {
        super(title);
    ...
    private JFreeChart setupChart() {
        ...
        chart = ChartFactory.createStackedBarChart("Per Packet Delays", "Packet", "ms", data, PlotOrientation.VERTICAL, true, false, false);
    ...
    private DefaultCategoryDataset fetchData() {
        ...
        if (!packetIds.isEmpty()) {
            ...
            sql_query = "SELECT packet_id, record_id, delay, hop_number "
                    ...
                    + "record_id BETWEEN :minPacketId and :maxPacketId "
                    + "ORDER BY record_id,hop_number ASC LIMIT :limit";
