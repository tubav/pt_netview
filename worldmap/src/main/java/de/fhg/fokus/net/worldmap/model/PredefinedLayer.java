...
public abstract class PredefinedLayer extends Layer implements  PersistentPreferences {
	private static final long serialVersionUID = -648897728504533131L;

	public PredefinedLayer(String layerId) {
		super(layerId);
	}
}
